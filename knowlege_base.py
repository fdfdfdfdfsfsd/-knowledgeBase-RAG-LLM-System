...
import os
import hashlib #计算字符串转md5(标记文件索引)
...
def save_md5(md5_str:str):
    ...
    """
    with open(config.md5_path,'a',encoding='utf-8')as f: #'a'在文件末尾添加内容
        f.write(md5_str + '\n')
...
if __name__=='__main__':
    ...
    text.upload_by_str("逞威风","testflie")